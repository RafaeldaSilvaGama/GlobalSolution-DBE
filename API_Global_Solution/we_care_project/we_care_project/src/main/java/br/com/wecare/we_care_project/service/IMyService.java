...
import br.com.wecare.we_care_project.Interfaces.IMyInterface;
...
@Slf4j
public class IMyService<T extends Serializable> implements IMyInterface<T> {
    ...
    IMyService(JpaRepository<T,Long> repository) {
